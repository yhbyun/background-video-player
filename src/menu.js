...
function getSettingsMenuItems(store, services, win) {
    ...
    const { defaultServiceMenuItems, enabledServicesMenuItems} = getServiceMenuItems(store, services, win);
            ...
            submenu: [
                {
                    ...
                    click(e) {
                        ...
                        if (!e.checked) setCheckboxMenuChecked('background-play', false);
                    },
                },
                { label: 'Opacity',
                    submenu: [
    ...
    return Menu.buildFromTemplate([
        {
            ...
            submenu: [
                { label: 'BackgroundVideoPlayer (' + app.getVersion() + ')', enabled: false },
                { role: 'quit' },
            ]
        },
        {
